<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="manageList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="合价" align="center" prop="totalPrice" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="合价" prop="totalPrice">
          <el-input v-model="form.totalPrice" placeholder="请输入合价" />
        </el-form-item>
...
<script>
import { listManage, getManage, delManage, addManage, updateManage, exportManage } from "@/api/site/manage";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        totalPrice: [
          { required: true, message: "合价不能为空", trigger: "blur" }
        ]
      }
    };
  },
  ...
  methods: {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有现场管理数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
