...
<script>
import { listTasks, getTasks, delTasks, addTasks, updateTasks, completeTasks ,exportTasks,undoTasks } from "@/api/work/tasks";
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      undoTasks(this.queryParams).then(response => {
